                    ...
                    <li>
                        ...
                        <?php else: ?>
                            <a href="<?php echo SITEURL; ?>login.php"
                                onclick="alert('Please log in to access this page');">Pets</a>
                        <?php endif; ?>
                    </li>
                    <li>
                        <?php if (isset($_SESSION['user_logged_in'])): ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo SITEURL; ?>login.php"
                                onclick="alert('Please log in to access this page');">Services</a>
                        <?php endif; ?>
                    </li>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <p>Find your perfect companion and give them a forever home. Our adoption process is simple,
                    transparent, and focused on both pet and adopter happiness.</p>
